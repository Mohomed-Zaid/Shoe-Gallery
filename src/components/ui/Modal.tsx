...
export function Modal({ title, children, onClose, size = 'md', respectSidebar = false }: ModalProps) {
  ...
  return (
    <div className={`fixed inset-y-0 right-0 left-0 z-[100] flex items-center justify-center bg-black/70 p-0 backdrop-blur-sm sm:p-4 ${respectSidebar ? 'md:left-[var(--sidebar-width)]' : ''}`} role="dialog" aria-modal="true" aria-labelledby="responsive-modal-title">
