...
const documentCss=`@page{margin:0}html,body{margin:0;padding:0;background:#fff}body{width:fit-content}.thermal-receipt{margin:0;box-shadow:none}`;

export function printReceipt(receipt:ReactNode) {
